...
public interface Deckable
{
	...
	//This must return the cards (Cardables) that were drawn previously 
	//(passed as a LinkedList<Cardable> parameter) back to the deck 
	//(do not recreate new cards, the same cards that were drawn must go back).
	...
	public String toString();  //This must return a String representation of the deck.
}